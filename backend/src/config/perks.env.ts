...
export const DEMO_LEAD_DRIP_INTERVAL_MS = parseInt(process.env.DEMO_LEAD_DRIP_INTERVAL_MS || '4500', 10);
...
export const DEMO_MIN_ACTIVE_LEADS = parseInt(process.env.DEMO_MIN_ACTIVE_LEADS || '8', 10);
