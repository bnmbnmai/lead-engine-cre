...
- **Chainlink Automation PoR** — `PersonalEscrowVaultUpkeep` ([0x9A565d…b700](https://sepolia.basescan.org/address/0x9A565d0dd3a004a2b1c8FAd536cfd33442f4b700)) runs 24h Proof-of-Reserves checks and auto-refunds expired locks. [Live upkeep dashboard →](https://automation.chain.link/base-sepolia/21294876610015716277122175951088366648605324800147651647408453016017624655922)
