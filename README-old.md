...
| Purchase Channel | Platform Cut | Convenience Fee | Bounty Cut | Notes |
|---|---|---|---|---|
| Manual (browser bid) | 5% | $1.00 | — | 5% deducted from seller's portion at settlement |
| Auto-bid engine | 5% | $1.00 | — | Same as manual; $1 locked on-chain with bid |
| API / MCP agent | 5% | $1.00 | — | Same as manual; $1 locked on-chain with bid |
| Buy It Now (RTBEscrow) | 2.5% | — | — | Legacy RTBEscrow.sol (deployed at 250 BPS) |
| Buyer Bounty release | 5% | — | — | 5% deducted from bounty payout to seller |

The $1 vault fee + bid amount are locked on-chain in `PersonalEscrowVault.sol` when the bid is placed. On settlement, the seller receives 95% of the bid amount, and the platform receives the 5% cut plus the $1 convenience fee. Losing bids are fully refunded (including the $1 fee). VerticalBountyPool bounty releases also take a 5% cut, with the seller receiving 95%.
